...
Creates class object; initialize it using ModbusMaster2::begin().

@ingroup setup
*/
ModbusMaster2::ModbusMaster2(void)
{
  _idle = 0;
  _preTransmission = 0;
  _postTransmission = 0;
...
@ingroup setup
*/
void ModbusMaster2::begin(uint8_t slave, Stream &serial)
{
...
void ModbusMaster2::beginTransmission(uint16_t u16Address)
{
...
uint8_t ModbusMaster2::requestFrom(uint16_t address, uint16_t quantity)
{
  uint8_t read;
...
void ModbusMaster2::sendBit(bool data)
{
...
void ModbusMaster2::send(uint16_t data)
{
...
void ModbusMaster2::send(uint32_t data)
{
  send(lowWord(data));
  send(highWord(data));
}
...
void ModbusMaster2::send(uint8_t data)
{
  send(word(data));
}
...
uint8_t ModbusMaster2::available(void)
{
  return _u8ResponseBufferLength - _u8ResponseBufferIndex;
}


uint16_t ModbusMaster2::receive(void)
{
...
@see ModbusMaster2::ModbusMasterTransaction()
*/
void ModbusMaster2::idle(void (*idle)())
{
  _idle = idle;
}
...
@see ModbusMaster2::ModbusMasterTransaction()
@see ModbusMaster2::postTransmission()
*/
void ModbusMaster2::preTransmission(void (*preTransmission)())
{
...
@see ModbusMaster2::ModbusMasterTransaction()
@see ModbusMaster2::preTransmission()
*/
void ModbusMaster2::postTransmission(void (*postTransmission)())
{
...
@see ModbusMaster2::clearResponseBuffer()
@param u8Index index of response buffer array (0x00..0x3F)
@return value in position u8Index of response buffer (0x0000..0xFFFF)
@ingroup buffer
*/
uint16_t ModbusMaster2::getResponseBuffer(uint8_t u8Index)
{
...
@see ModbusMaster2::getResponseBuffer(uint8_t u8Index)
@ingroup buffer
*/
void ModbusMaster2::clearResponseBuffer()
{
  uint8_t i;
...
@see ModbusMaster2::clearTransmitBuffer()
@param u8Index index of transmit buffer array (0x00..0x3F)
@param u16Value value to place in position u8Index of transmit buffer (0x0000..0xFFFF)
@return 0 on success; exception number on failure
@ingroup buffer
*/
uint8_t ModbusMaster2::setTransmitBuffer(uint8_t u8Index, uint16_t u16Value)
{
  if (u8Index < ku8MaxBufferSize)
  {
...
@see ModbusMaster2::setTransmitBuffer(uint8_t u8Index, uint16_t u16Value)
@ingroup buffer
*/
void ModbusMaster2::clearTransmitBuffer()
{
  uint8_t i;
...
@ingroup discrete
*/
uint8_t ModbusMaster2::readCoils(uint16_t u16ReadAddress, uint16_t u16BitQty)
{
...
@ingroup discrete
*/
uint8_t ModbusMaster2::readDiscreteInputs(uint16_t u16ReadAddress,
  uint16_t u16BitQty)
{
  _u16ReadAddress = u16ReadAddress;
  _u16ReadQty = u16BitQty;
...
@ingroup register
*/
uint8_t ModbusMaster2::readHoldingRegisters(uint16_t u16ReadAddress,
  uint16_t u16ReadQty)
{
  _u16ReadAddress = u16ReadAddress;
...
@ingroup register
*/
uint8_t ModbusMaster2::readInputRegisters(uint16_t u16ReadAddress,
  uint8_t u16ReadQty)
{
  _u16ReadAddress = u16ReadAddress;
  _u16ReadQty = u16ReadQty;
...
@ingroup discrete
*/
uint8_t ModbusMaster2::writeSingleCoil(uint16_t u16WriteAddress, uint8_t u8State)
{
...
@ingroup register
*/
uint8_t ModbusMaster2::writeSingleRegister(uint16_t u16WriteAddress,
...
@ingroup discrete
*/
uint8_t ModbusMaster2::writeMultipleCoils(uint16_t u16WriteAddress,
  uint16_t u16BitQty)
{
  _u16WriteAddress = u16WriteAddress;
...
uint8_t ModbusMaster2::writeMultipleCoils()
{
...
@ingroup register
*/
uint8_t ModbusMaster2::writeMultipleRegisters(uint16_t u16WriteAddress,
...
uint8_t ModbusMaster2::writeMultipleRegisters()
{
...
@ingroup register
*/
uint8_t ModbusMaster2::maskWriteRegister(uint16_t u16WriteAddress,
...
@ingroup register
*/
uint8_t ModbusMaster2::readWriteMultipleRegisters(uint16_t u16ReadAddress,
...
@return 0 on success; exception number on failure
*/
uint8_t ModbusMaster2::ModbusMasterTransaction(uint8_t u8MBFunction)
{
