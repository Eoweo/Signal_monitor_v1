...
class StartWindow(QWidget): 
    ...
    def cargar_status_bar(self, signal): 
        """ Este método recibirá una señal creada desde el MainWindow. Esta señal permitirá al widget central emitir cambios al status bar. """ 
...
class MainWindow(QMainWindow): 
    ...
    def __init__(self): 
        ...
        """ Configuramos el widget central con una instancia de la clase MiVentana(). 
        Además cargamos la señal en el central widget para que este pueda interactuar con la barra de estados de la ventana principal. """ 
